(function($) {
	...
	$.fn.bgVideo.defaults = {
		...
		pausePlayXOffset: '0px', // pixels or percent from side - ignored if positioned center
		pausePlayYOffset: '0px' // pixels or percent from top/bottom - ignored if positioned center
	};
